...
export default function AuthPage() {
  ...
  // const url = 'https://164c9c83-616f-463a-a447-0a1887abced2-00-2o6p2816y620o.picard.replit.dev';
      ...
      <Row>
        ...
        <Col sm={6} className="p-4" >
          ...
          <Col sm={5} className="d-grid gap-2" >
            ...
            <p style={{ fontSize: '12px' }} >By signing up, you agree to the Terms and Service and Privacy Policy, including Cookie Use.</p>
            ...
            <Modal.Body>
              ...
              >
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword"  >
                  ...
                  {errorMessage && <p className="mt-2" style={{ color: 'red' }} >{errorMessage}</p>}
                </Form.Group>
